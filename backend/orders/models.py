...
class Order(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default="pending_confirmation"
    )
    ...
    cashfree_order_id = models.CharField(max_length=64, blank=True)
    ...
    delivery_location_updated_at = models.DateTimeField(null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.order_number:
            ...
            self.order_number = f"HDK{next_id}"
