...
class _CustomerManagementScreenState extends State<CustomerManagementScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final data = await _svc.getCustomersPaged(
        page: _page,
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    _search.text.isEmpty ? 'No customers yet' : 'No results',
                    style: GoogleFonts.poppins(
                      color: Colors.grey,
                      fontSize: 16,
                    ),
                ...
                itemBuilder: (_, i) {
                  ...
                  return _CustomerCard(
                    ...
                    onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            CustomerDetailScreen(customerId: filtered[i].id),
                      ),
                    ).then((_) => _refresh()),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: _surface,
        title: Text(
          _detail?.customer.displayName ?? 'Customer',
          style: GoogleFonts.poppins(
            color: Colors.white,
            fontWeight: FontWeight.w600,
          ),
  ...
  Widget _buildBody() {
    ...
    return ListView(
      ...
      children: [
        ...
        // ── Recent orders ───────────────────────────────────────────────────
        Text(
          'Recent Orders (${d.recentOrders.length})',
          style: GoogleFonts.poppins(
            color: Colors.white,
            fontWeight: FontWeight.w700,
            fontSize: 14,
