...
const _stroke = Color(0xFF262626);
        ...
        actions: [
          if (_unreadCount > 0)
            TextButton(
              ...
              child: const Text('Mark all read', style: TextStyle(color: _red, fontWeight: FontWeight.bold, fontSize: 13)),
            ),
        ],
      ),
      body: _loading
              ...
              : _list.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.notifications_none_rounded, color: Colors.grey[800], size: 64),
                          const SizedBox(height: 16),
                          Text('No notifications',
                              style: GoogleFonts.poppins(color: _textPrimary, fontWeight: FontWeight.bold, fontSize: 16)),
                          const SizedBox(height: 6),
                          const Text('Notifications list is empty.',
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            shape: RoundedRectangleBorder(
                              ...
                              side: BorderSide(
                                color: item.isRead ? _stroke : _red.withValues(alpha: 0.3),
                            ...
                            child: ListTile(
                              ...
                              leading: CircleAvatar(
                                backgroundColor: item.isRead ? _stroke : _red.withValues(alpha: 0.1),
                                child: Icon(
                                  item.isRead ? Icons.drafts_outlined : Icons.mark_email_unread_outlined,
                                  color: item.isRead ? _textSecondary : _red,
                                  size: 20,
                                ),
                              ),
                              title: Row(
